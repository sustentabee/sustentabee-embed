...
const char* password = "2123212328102810";
const char* mqtt_server = "jackal.rmq.cloudamqp.com";
const char* mqtt_user = "ujbcsifw:ujbcsifw";
const char* mqtt_password = "1us-CrjDYvQStaK1SVxIYyXmtS1ajJcp";
...
void loop() {
    ...
    if (millisNow - lastMillis > 2000) {
        ...
        time_payload["type"] = "curr_temp";
        time_payload["serial_no"] = serial_no;
        time_payload["timestamp"] = getCurrentTimestampString();
        time_payload["temperature"] = temperature;
        time_payload["current"] = current;
